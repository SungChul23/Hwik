...
/// 최종 값
class FeedItemStruct extends BaseStruct {
  FeedItemStruct({
    String? videoId,
    String? videoUrl,
    String? title,
    ...
    bool? hasLearned,
    List<LearningActivityStruct>? learningActivities,

    /// 웹소캣 정보
    WebSocketContextTypeStruct? webSocketContext,
    MyTestShortFormVideoStruct? myTestShortFormVideo,
  })  : _videoId = videoId,
        _videoUrl = videoUrl,
        _title = title,
        ...
        _myTestShortFormVideo = myTestShortFormVideo;
  ...
  List<LearningActivityStruct>? _learningActivities;
  List<LearningActivityStruct> get learningActivities =>
      _learningActivities ?? const [];
  set learningActivities(List<LearningActivityStruct>? val) =>
      _learningActivities = val;

  void updateLearningActivities(
      Function(List<LearningActivityStruct>) updateFn) {
  ...
  // "myTestShortFormVideo" field.
  MyTestShortFormVideoStruct? _myTestShortFormVideo;
  MyTestShortFormVideoStruct get myTestShortFormVideo =>
      _myTestShortFormVideo ?? MyTestShortFormVideoStruct();
  set myTestShortFormVideo(MyTestShortFormVideoStruct? val) =>
      _myTestShortFormVideo = val;

  void updateMyTestShortFormVideo(
      Function(MyTestShortFormVideoStruct) updateFn) {
    updateFn(_myTestShortFormVideo ??= MyTestShortFormVideoStruct());
  }

  bool hasMyTestShortFormVideo() => _myTestShortFormVideo != null;

  static FeedItemStruct fromMap(Map<String, dynamic> data) => FeedItemStruct(
        ...
        learningActivities: getStructList(
          ...
          LearningActivityStruct.fromMap,
        ),
        ...
        myTestShortFormVideo:
            data['myTestShortFormVideo'] is MyTestShortFormVideoStruct
                ? data['myTestShortFormVideo']
                : MyTestShortFormVideoStruct.maybeFromMap(
                    data['myTestShortFormVideo']),
      );

  static FeedItemStruct? maybeFromMap(dynamic data) =>
      data is Map ? FeedItemStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'myTestShortFormVideo': _myTestShortFormVideo?.toMap(),
      }.withoutNulls;
  ...
  Map<String, dynamic> toSerializableMap() => {
        ...
        'myTestShortFormVideo': serializeParam(
          _myTestShortFormVideo,
          ParamType.DataStruct,
        ),
      }.withoutNulls;

  static FeedItemStruct fromSerializableMap(Map<String, dynamic> data) =>
      FeedItemStruct(
        ...
        learningActivities: deserializeStructParam<LearningActivityStruct>(
          data['learning_activities'],
          ParamType.DataStruct,
          true,
          structBuilder: LearningActivityStruct.fromSerializableMap,
        ),
        ...
        myTestShortFormVideo: deserializeStructParam(
          data['myTestShortFormVideo'],
          ParamType.DataStruct,
          false,
          structBuilder: MyTestShortFormVideoStruct.fromSerializableMap,
        ),
      );

  @override
  String toString() => 'FeedItemStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is FeedItemStruct &&
        ...
        myTestShortFormVideo == other.myTestShortFormVideo;
  }
...
FeedItemStruct createFeedItemStruct({
  String? videoId,
  String? videoUrl,
  String? title,
  String? characterInfo,
  ...
  MyTestShortFormVideoStruct? myTestShortFormVideo,
    ...
    FeedItemStruct(
      ...
      myTestShortFormVideo:
          myTestShortFormVideo ?? MyTestShortFormVideoStruct(),
    );

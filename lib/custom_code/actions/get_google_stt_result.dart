...
/// Return type: JSON
Future<dynamic> getGoogleSttResult(
  ...
  final Map<String, dynamic> configMap = {
    ...
    'alternativeLanguageCodes':
        (alternativeLanguageCode.isNotEmpty) ? [alternativeLanguageCode] : [],
  ...
  if (results.isEmpty) {
    ...
    return {'transcript': '', 'languageCode': primaryLanguageCode};
  }
  ...
  String lang = first['languageCode']?.toString() ?? primaryLanguageCode;
  if (lang.contains('-')) {
    final p = lang.split('-');

...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hwikAuthUserSubject.add(
      HwikAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HwikAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HwikAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HwikAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    hwikAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
